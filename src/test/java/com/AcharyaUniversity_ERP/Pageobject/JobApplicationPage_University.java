...
public class JobApplicationPage_University {
	...
	@FindBy(xpath = "//div[@class='MuiDataGrid-virtualScrollerRenderZone css-1inm7gi']/div[2]/div[6]/button")
	public WebElement HRSplusicon;
	
	@FindBy(xpath = "//div[@class='MuiDataGrid-virtualScrollerRenderZone css-1inm7gi']/div[2]/div[7]/div")
	public WebElement HRStatus;
	
	@FindBy(xpath = "//div[@class='MuiDataGrid-virtualScrollerRenderZone css-1inm7gi']/div[2]/div[8]/button")
	public WebElement Interviewplusicon;
	
	@FindBy(xpath = "//div[@class='MuiDataGrid-virtualScrollerRenderZone css-1inm7gi']/div[2]/div[9]/button")
	public WebElement Resultplusicon;
	
	@FindBy(xpath = "//div[@class='MuiDataGrid-virtualScrollerRenderZone css-1inm7gi']/div[2]/div[10]/button")
	public WebElement salaryBreakUp_Plusicon;
	
	@FindBy(xpath = "//div[@class='MuiDataGrid-virtualScrollerRenderZone css-1inm7gi']/div[2]/div[12]/button")
	public WebElement Job_offer;
	
	@FindBy(xpath = "//div[@class='MuiDataGrid-virtualScrollerRenderZone css-1inm7gi']/div[2]/div[13]/button")
	public WebElement Recruitment;
	
	@FindBy(xpath = "//div[@class='MuiDataGrid-virtualScrollerRenderZone css-1inm7gi']/div[2]/div[11]/button")
	...
	wait.selectdropdownwithnoselecttag(stadropdowns, "Shortlisted" , 3000);		
	 ...
	 wait.clickOnElement(ele1, ExplicitwaitMethods.EXPLICIT_WAIT_BASIC_TIME);
	 wait.typeTextIntoElementforclearingtext(ele1, "candidate shortlisted", ExplicitwaitMethods.EXPLICIT_WAIT_BASIC_TIME);
